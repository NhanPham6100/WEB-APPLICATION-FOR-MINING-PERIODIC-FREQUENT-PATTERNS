...
//				// we create an object for writing the output file
    ...
    public void convert(String inputDB, String outputFile, String outputFileConverted, Charset charset)
        ...
        // For example, a line: @ITEM=16=weight=red indicate that the item 16 correspond to the string "weight=red"
        ...
        // A map that An entry in the map is: key = String (attribute value); value = Integer (item id)
...
//				System.out.println(stringValue);
        ...
        myInputDB.close(); // close the file
